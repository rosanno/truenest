...
const Header = () => {
  ...
  const name = `${data?.user.profileId.firstName} ${data?.user.profileId.lastName}`;
        ...
        <div className="h-[80px] flex items-center justify-between px-8">
          ...
          <div className="relative w-[400px]">
            <Input
              ...
              className="pl-10 w-full border-0 shadow-none bg-[#F7F8F9] h-11 placeholder:text-muted-foreground text-xl focus-visible:ring-0"
            />
