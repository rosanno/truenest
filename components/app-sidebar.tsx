    ...
    <Sidebar className="border-r-0! shadow-lg">
      <SidebarHeader className="bg-white! p-0">
        <div className="flex items-center gap-2 px-4 py-5">
          ...
          <span className="text-lg font-extrabold tracking-tight text-[#F34451]">
            Truenest
          </span>
        </div>
          ...
          <div className="px-4 py-3 flex items-center gap-x-3">
            ...
            <div>
              <h6 className="font-medium text-base">
                {data?.user?.profileId.firstName}{" "}
                {data?.user?.profileId.lastName}
              </h6>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    ...
                    className={cn(
                      ...
                      pathname === item.url &&
                        "bg-[#F34451]/5 text-[#F34451] border-l-[5px] border-[#F34451]"
                    )}
                  >
        ...
        <div className="px-1.5 mt-24">
          <div className="relative bg-[#F34451]/10 rounded-xl p-5 pt-16">
            <img
              ...
              alt="house svg"
              className="absolute left-1/2 -translate-x-1/2 -top-28 size-48"
            />
            <div className="relative z-10 text-center">
              <h6 className="text-base text-[#F34451] font-semibold mb-2">
                Need Help
              </h6>
              <a
                href="#"
                className="text-base text-[#F34451] hover:underline"
              >
                <span>
                  Raise ticket at
                  &quot;support@truenest.com&quot;
                </span>
              </a>
              <Button
